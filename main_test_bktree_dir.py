...
tf.app.flags.DEFINE_string('test_data_path', '/data/ceph_11015/ssd/anhan/nba/video2image/nba_2019/frame/nba_2019/', '')
...
'/data/ceph_11015/ssd/anhan/nba/FOTS_TF/outputs/outputs_bs16_540p_v1106_aughsv_2019_v1113_before', '')
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for im_fn in im_fn_list:
                ...
                if boxes is not None and boxes.shape[0] != 0:
                    ...
                    res_file_path = os.path.join(FLAGS.output_dir, '{}.txt'.format(im_fn.split('/')[-2]+os.path.basename(im_fn)))
                ...
                if not FLAGS.no_write_images:
                    img_path = os.path.join(FLAGS.output_dir, im_fn.split('/')[-2]+os.path.basename(im_fn))
